...
if($type == 'input') { 
?>
<div><input <?php echo $classAttribute . $attributes_html; ?> type="text" name="<?php echo $key; ?>" id="<?php echo $key; ?>" value="<?php echo $_POST[$key]; ?>" /></div>
<?php
}
...
<div id="captcha_div"><img width="<?php echo CAPTCHA_IMAGE_WIDTH; ?>" height="<?php echo CAPTCHA_IMAGE_HEIGHT; ?>" id="captcha" src="/inc/contact-app/captcha.php" alt="" />&nbsp;<a id="captcha-refresh" href="#"><img id="icon-refresh" alt="" width="16" height="16" src="/images/contact/icon-refresh.png" /></a></div>  
...
<input id="submit-button" class="button" type="submit" name="submit" value="Send Message" /><div id="ajax-loading">Submitting...</div>
