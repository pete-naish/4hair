...
define('WEBMASTER_EMAIL', 'info@4-hair.co.uk');

// your name/nickname
define('WEBMASTER_NAME', '4-hair');
...
define('PATH_TO_IMAGES', '/images/contact/');
...
$formFields = array('sender_name'    => array('name'        => 'Name',
											  ...
											  'errors'      => array('none' => 'Fill in your name')),
                    ...
                    'sender_email'   => array('name'        => 'Email',
											  ...
											  'errors'      => array('none'    => 'Fill in an e-mail address', 
					...
					'sender_message' => array('name'        => 'Message',
											  ...
											  'errors'      => array('none'      => 'Fill in your message',
